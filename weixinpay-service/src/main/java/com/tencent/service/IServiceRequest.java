...
public interface IServiceRequest {
    ...
    String sendPost(String api_url, String xml) throws UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException, KeyStoreException, IOException;
