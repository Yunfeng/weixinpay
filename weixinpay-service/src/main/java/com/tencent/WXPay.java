...
import cn.buk.pay.service.SandboxSignKeyService;
...
public class WXPay {
    ...
    public static String requestUnifiedOrderService(WxpData reqData) throws Exception{
        return new UnifiedOrderService().request(reqData);
    }

    public static String requestSandboxSignKeyService(SandboxSignKeyReqData reqData) throws Exception{
        return new SandboxSignKeyService().request(reqData);
    }
